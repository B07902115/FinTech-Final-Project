class Strategy():
    ...
    def __init__(self):
        ...
        self.ma_short = 11                     # Range of coverage of the short MA, in periods
        ...
        self.UP = 1
        self.DOWN = 2
        Log("peroid: %d; long: %d; short: %d buy ratio %d" %(self.period, self.ma_long, self.ma_short, self.buy_ratio))
    ...
    def trade(self, information):
        ...
        if self.last_type == 'sell' and cur_cross == self.UP and self.last_cross_status == self.DOWN:
            ...
            action = 'sell'
        elif self.last_type == 'buy' and self.last_buy > -1 and self.last_buy - close_price > 100:
            action = 'sell'
        # cross up
        if action == 'buy':
